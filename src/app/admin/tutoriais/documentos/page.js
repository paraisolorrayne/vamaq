...
export const metadata = {
  title: "Tutorial: Documentos — Vamaq Motors",
};
...
export default function TutorialDocumentosPage() {
  return (
    <div className={guia.wrap}>
      <Link href="/admin/tutoriais" className={guia.backLink}>
        ← Todos os tutoriais
      </Link>

      <div className={styles.pageHeader}>
        <h1 className={styles.pageTitle}>Documentos: como gerar um contrato</h1>
